...
import { Account, InboundGroupSession, OutboundGroupSession, Session, Utility } from "@sending-network/olm";
    ...
    public exportInboundGroupSession(
        ...
        return this.unpickleInboundGroupSession(sessionData, (session) => {
            ...
            return {
                ...
                "org.sendingnetwork.msc3061.shared_history": sessionData.sharedHistory || false,
