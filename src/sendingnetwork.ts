 ...
 * options will be passed directly to {@link module:client.SendingNetworkClient}.
 * @param {Object} opts.store If not set, defaults to
 * {@link module:store/memory.MemoryStore}.
 * @param {Object} opts.scheduler If not set, defaults to
 * {@link module:scheduler~SendingNetworkScheduler}.
 ...
 *    in-memory otherwise).
 *
 * @return {SendingNetworkClient} A new sendingnetwork client.
 ...
 * @param {Object} opts._sendingnetwork_opts The underlying options set for
 * {@link SendingNetworkHttpApi}.
