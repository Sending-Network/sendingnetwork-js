...
export class RoomMember extends EventEmitter {
     ...
     * disambiguated with a suffix of " (@user_id:sending.network)" if another member shares the
     * same displayname.
     ...
     * @param {SendingNetworkEvent} event The <code>m.room.member</code> event
     * @param {RoomState} roomState Optional. The room state to take into account
     * when calculating (e.g. for disambiguating users with the same name).
     * @fires module:client~SendingNetworkClient#event:"RoomMember.name"
     ...
     * @param {SendingNetworkEvent} powerLevelEvent The <code>m.room.power_levels</code>
     * event
     * @fires module:client~SendingNetworkClient#event:"RoomMember.powerLevel"
     */
    public setPowerLevelEvent(powerLevelEvent: SendingNetworkEvent): void {
     ...
     * @fires module:client~SendingNetworkClient#event:"RoomMember.typing"
     */
     ...
     * @param {string} baseUrl The base node URL See
     ...
     * returned even if it is a direct hyperlink rather than a sendingnetwork content URL.
     * If false, any non-sendingnetwork content URLs will be ignored. Setting this option to
 ...
 * @event module:client~SendingNetworkClient#"RoomMember.name"
 ...
 *    name previously.
 * @example
 * sendingNetworkClient.on("RoomMember.name", function(event, member){
 ...
 * @event module:client~SendingNetworkClient#"RoomMember.membership"
 * @param {SendingNetworkEvent} event The sendingnetwork event which caused this event to fire.
 ...
 *    new member.
 * @example
 * sendingNetworkClient.on("RoomMember.membership", function(event, member, oldMembership){
 ...
 * @event module:client~SendingNetworkClient#"RoomMember.typing"
 * @param {SendingNetworkEvent} event The sendingnetwork event which caused this event to fire.
 * @param {RoomMember} member The member whose RoomMember.typing changed.
 * @example
 * sendingNetworkClient.on("RoomMember.typing", function(event, member){
 ...
 * @event module:client~SendingNetworkClient#"RoomMember.powerLevel"
 * @param {SendingNetworkEvent} event The sendingnetwork event which caused this event to fire.
 * @param {RoomMember} member The member whose RoomMember.powerLevel changed.
 * @example
 * sendingNetworkClient.on("RoomMember.powerLevel", function(event, member){
