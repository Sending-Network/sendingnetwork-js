...
import { IStartClientOpts, IAsset } from "../client";
...
export interface IStore {
    readonly accountData: Record<string, SendingNetworkEvent>; // type : content
     ...
     * @return {Array}
     */
    scrollback(room: Room, limit: number): SendingNetworkEvent[];
     ...
     */
    storeEvents(room: Room, events: SendingNetworkEvent[], token: string, toStart: boolean);
     ...
     * @param {Array<SendingNetworkEvent>} events The events to store.
     */
    storeAccountDataEvents(events: SendingNetworkEvent[]);

    /**
     * Get account data event by event type
     * @param {string} eventType The event type being queried
     */
    getAccountData(eventType: EventType | string): SendingNetworkEvent;
    ...
    storeAssets(assets: IAssetCache): Promise<void>;

    getAssets(): Promise<IAssetCache>;
}
