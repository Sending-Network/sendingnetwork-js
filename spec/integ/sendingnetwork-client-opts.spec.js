...
import HttpBackend from "sendingnetwork-mock-request";
import { SendingNetworkClient } from "../../src/sendingnetwork";
import { SendingNetworkScheduler } from "../../src/scheduler";
import { MemoryStore } from "../../src/store/memory";
import { SendingNetworkError } from "../../src/http-api";

describe("SendingNetworkClient opts", function() {
    ...
    describe("without opts.store", function() {
        beforeEach(function() {
            client = new SendingNetworkClient({
    ...
    describe("without opts.scheduler", function() {
        ...
        it("shouldn't retry sending events", function(done) {
            httpBackend.when("PUT", "/txn1").fail(500, new SendingNetworkError({
                errcode: "M_SOMETHING",
                error: "Ruh roh",
            }));
            client.sendTextMessage("!foo:bar", "a body", "txn1").then(function(res) {
