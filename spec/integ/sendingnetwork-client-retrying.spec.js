import { EventStatus } from "../../src/sendingnetwork";
import { SendingNetworkScheduler } from "../../src/scheduler";
import { Room } from "../../src/models/room";
import { TestClient } from "../TestClient";

describe("SendingNetworkClient retrying", function() {
    let client = null;
    ...
    beforeEach(function() {
        scheduler = new SendingNetworkScheduler();
    ...
    xit("should retry according to SendingNetworkScheduler.retryFn", function() {

    });

    xit("should queue according to SendingNetworkScheduler.queueFn", function() {
