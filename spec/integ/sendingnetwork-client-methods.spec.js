...
import { Filter, MemoryStore, Room } from "../../src/sendingnetwork";
...
describe("SendingNetworkClient", function() {
    ...
    describe("uploadContent", function() {
        ...
        it("should parse errors into a SendingNetworkError", function() {
            httpBackend.when(
                "POST", "/_api/media/r0/upload",
            ).check(function(req) {
                expect(req.rawData).toEqual(buf);
    ...
    describe("deleteDevice", function() {
        ...
        it("should pass through an auth dict", function() {
            httpBackend.when(
                "DELETE", "/_api/client/r0/devices/my_device",
            ).check(function(req) {
