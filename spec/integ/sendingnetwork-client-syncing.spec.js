...
describe("SendingNetworkClient syncing", function() {
    let client = null;
    ...
    describe("receipts", function() {
        ...
        it("should sync receipts from /sync.", function() {
            ...
            return Promise.all([
                ...
                const room = client.getRoom(roomOne);
                expect(room.getReceiptsForEvent(new SendingNetworkEvent(ackEvent))).toEqual([{
                    type: "m.read",
                    userId: userC,
                    data: {
                        ts: 176592842636,
    ...
    /**
     * waits for the SendingNetworkClient to emit one or more 'sync' events.
     *
