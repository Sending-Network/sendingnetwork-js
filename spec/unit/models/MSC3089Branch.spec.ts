...
import { IContent, SendingNetworkClient, SendingNetworkEvent } from "../../../src";
...
describe("MSC3089Branch", () => {
    ...
    beforeEach(() => {
        ...
        } as SendingNetworkEvent, directory);
    });
    ...
    it('should be able to return event information', async () => {
        ...
        client.mxcUrlToHttp = (mxc: string) => {
            ...
            return `https://example.org/_api/media/v1/download/${mxcLatter}`;
        };
