...
describe('NotificationService', function() {
    const testUserId = "@ali:sending.network";
    ...
    beforeEach(function() {
        ...
        pushProcessor = new PushProcessor(sendingNetworkClient);
    });

    // User IDs

    it('should bing on a user ID.', function() {
        testEvent.event.content.body = "Hello @ali:sending.network, how are you?";
