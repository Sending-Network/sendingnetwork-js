...
import "./setupTests";
import "../../dist/browser-sendingnetwork"; // uses browser-sendingnetwork instead of the src
...
describe("Browserify Test", function() {
    ...
    async function createTestClient() {
        ...
        const client = sendingNetworkcs.createClient(options);
